        ...
        <div class="row">
            ...
            <div class="col-md-6 m-auto">
                ...
                <form class="form-group" action="./../../api/api_controller.php" method="post"
                    ...
                    <input type="hidden" name="vendorMess" value="" class="">
...
$(document).ready(() => {
    ...
    $(".receiverid").val(user_id)

    $.ajax({
        url: './../../api/api_controller.php',
        type: 'POST',
        data: {
            "FetchmessagesVendor": "FetchmessagesVendor",
            "user_id": user_id
        },
        dataType: "JSON",
        success: data => {
    ...
    function createheader(data) {
        $.each(data.data, (i, val) => {
            output = `
                ...
                <h4 class='nametag'><i class="fa fa-user mr-2 text-primary bg-light p-2" style="border-radius:1000px;"></i>${val.username}</h4>
                </center>
              `
            ...
            output = `
                        <div class="card">
                                <div class="card-header bg-dark">
                                    <h4 class="text-warning"><i class="fa fa-user fa-2x mr-2 bg-light p-2" style="border-radius:1000px;"></i>${val.username}</h4>
                                </div>
                                <div class="card-body text-warning bg-dark">
                                <h6><i class="fa fa-dashboard mr-2"></i>Address : ${val.address}</h6>
